  ...
  <div class="wrap">
    ...
    <div class="mini-grid reveal">
      ...
      <article class="mini">
        ...
        <a class="plink" href="/roll-dice" target="_blank" rel="noopener">Voir le projet <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M7 17L17 7M9 7h8v8"/></svg></a>
      </article>
      <article class="mini">
        <span class="mini__k">Projet perso · Solo</span>
